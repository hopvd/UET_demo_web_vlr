const options_valorant = {
  ...
  fetch('https://api.pandascore.co/valorant/matches/past?page[size]=10', options_valorant)
    ...
    .then(function(posts){
        ...
        var html = htmls.join('');
        document.getElementById('vods-valorant').innerHTML = html; 
    })
